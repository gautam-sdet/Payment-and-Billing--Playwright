...
test.describe("SubscriptionStateMachine", () => {
  ...
  test("treats canceled as terminal", () => {
  ...
  test("ignores CHARGE_FAILED while already past_due (dunning stays until retries exhaust)", () => {
